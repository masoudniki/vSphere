...
class PowerTest extends TestCase
{
    ...
    public function test_power_off_vm(){
        ...
        $this->assertLastRequestEquals("POST","/vcenter/vm/vm-111/power/stop");
    ...
    public function test_reset_vm(){
        ...
        $this->assertLastRequestEquals("POST","/vcenter/vm/vm-222/power/reset");
        $this->assertLastRequestBodyIsEmpty();
    }
    public function test_suspend_vm(){
        $this->mockHandler->append(new Response(200,[],""));
        $this->assertTrue($this->power->suspend('vm-222'));
        $this->assertLastRequestEquals("POST","/vcenter/vm/vm-222/power/suspend");
        $this->assertLastRequestBodyIsEmpty();
    }
    public function test_get_power(){
        ...
        $this->assertLastRequestEquals("GET","/vcenter/vm/vm-111/power");
