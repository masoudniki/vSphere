<?php
    ...
    class VmwareApiClient{
        ...
        public $protocol;
        public $port;
        public function __construct($host,array $credential,$port=443,$ssl=false,$protocol="https",$baseurl="/rest/vcenter",$authurl="/rest/com/vmware/cis/session",?Client $client)
        {
            $this->host=$host;
            $this->port=$port;
